...
function Topbar({ crumb, actions, slim = false }: { crumb?: ReactNode; actions?: ReactNode; slim?: boolean }) {
  return (
    <div className={`flex items-center justify-between border-b border-line bg-paper ${slim ? 'px-7 py-2.5' : 'px-8 py-3.5'}`}>
      ...
      <div className="flex items-center gap-2.5">
        <div className="relative w-[220px] rounded-[7px] border border-line bg-card py-[5px] pr-2.5 pl-7 font-mono text-[12.5px] text-ink-3">
  ...
  return (
    <div className="grid h-screen grid-cols-[224px_1fr]">
      ...
      <div className="flex min-w-0 flex-col overflow-hidden">
        <Topbar crumb={crumb} actions={actions} slim={slim} />
